    ...
    $.ajax({
        ...
        success: function (resposta) {
            ...
            if (!!success && escola) {
                ...
                if (carencia) {
                    for (var i = 0; carencia.length > i; i++) { // console.log(carencias[i].temporaria);
                        ...
                        $("#tabelaCarencia").append("<tr class='linha_carencia'>" + "<td>" + carencia[i].nome + "</td>" + "<td class='text-center'>" + temp + "</td>" + "<td class='text-center'>" + carencia[i].matutino + "</td>" + "<td class='text-center'>" + MatProv + "</td>" + "<td class='text-center'>" + carencia[i].vespertino + "</td>" + "<td class='text-center'>" + VespProv + "</td>" + "<td class='text-center'>" + carencia[i].noturno + "<td class='text-center'>" + NotProv + "</td>" + "<td class='text-center'>" + carencia[i].total + "</td>" ); 

...
function Salvar_Provimento() {
    ...
    tdBotoes.html(
        "<img src='images/delete.png' class='btnExcluir'/><img src='images/pencil.png' class='btnEditar'/>"
    );
...
function Editar_Provimento() {
    ...
    tdNome.html(
        "<input type='text' id='txtNome' value='" + tdNome.html() + "'/>"
    );
    tdTelefone.html(
    ...
    tdEmail.html(
        "<input type='text' id='txtEmail' value='" + tdEmail.html() + "'/>"
    );

            ...
            <div class="container shadow-sm p-3 mb-5 bg-white rounded ">
                ...
                <form action="<?= '/system/grupos/store' ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" id="name" value="<?php echo isset($grupos['name']) ? $grupos['name'] : ''; ?>" required>
                    </div>

                    <div class="form-group">
                        <label class="control-label">Descrição:</label>
                        <input type="text" class="form-control" name="description" id="inputDefault" value="<?php echo isset($grupos['description']) ? $grupos['description'] : ''; ?>">
                    </div>

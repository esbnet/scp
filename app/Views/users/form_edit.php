            ...
            <div class="container shadow p-3 mb-5 bg-white rounded ">
                ...
                <div class="form-group row">
                    <div class="col-md-3">
                        ...
                        <input id="username" name="username" type="text" class="form-control" aria-describedby="userHelp" value="<?= isset($users['username']) ? $users['username'] : '' ?>" maxlength="30" disabled>
                        <small id="userHelp" class="form-text text-danger"><?= isset($user->username) ? $user['username'] : ""; ?></small>
                    </div>
                    <div class="col-md-4">
                        <label for="username">Nome<span class="text-danger">*</span></label>
                        <input id="username" name="username" type="text" class="form-control" aria-describedby="userHelp" value="<?= isset($users['name']) ? $users['name'] : '' ?>" maxlength="100" required>
                        <small id="userHelp" class="form-text text-danger"><?= isset($user->username) ? $user['name'] : ""; ?></small>
                    </div>
                    <div class="col-md-5">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-control" name="Inputstatus" id="active" required>
                            <!-- <option value="" selected>...</option> -->
                            <option value="1" <?php (isset($user->active) == 1 ? 'selected' : ''); ?> >Sim</option>
                            <option value="0" <?php (isset($user->active) == 0 ? 'selected' : ''); ?> >Não</option>
                        </select>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="password" class="form-control" id="password_hash" name="password_hash" aria-describedby="password_hashHelp" value="" maxlength="15" >
                        <small id="password_hashHelp" class="form-text text-danger"><?= isset($user['password_hash']) ? $user['password_hash'] : ""; ?></small>
                    </div>
                    <div class="col-md-3">
                        <label for="user_confirm">Confirmação</span></label>
                        <input type="password" class="form-control" id="user_confirm" name="user_confirm" aria-describedby="confirmHelp" value="" maxlength="15" >

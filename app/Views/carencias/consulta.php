                    ...
                    <div id="borderCard" class="card-body border-down-primary">
                        <div class="form-row ">
                            <div class="form-group col-md-4">
                                ...
                                <select name="nte" id="nte_cs" class="form-control form-control-sm" required>
                        ...
                        <div class="form-row ">
                            <div class="form-group col-md-2">
                                <label class="control-label" for="NomeProfessor">Cód.UE</label>
                                <input value="" type="text" class="form-control form-control-sm" name="ue_id" id="ueid_cs">
                            </div>

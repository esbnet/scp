...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <form class="users needs-validation shadow" action="<?= '/provimentos/store' ?>" method="post">
            ...
            <div class="card-body ">
                ...
                <div class="form-row quadroTabelaCarencia">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="form-row linha-01">
                            <div class="form-group col-md-2">
                                ...
                                <div class="input-group mb-3">
                                    <input title="CodSecul ou Cod. SAP ou CPF" data-toggle="tooltip" data-placement="top" title="Tooltip na parte superior" type="number" value="<?= isset($provimento['professor_matricula']) ? $provimento['professor_matricula'] : '' ?>" size="9" name="matricula_Id" id="Matricula" class="form-control form-control-sm text-primary matricula" readonly>
                        ...
                        <div class="form-row linha-04 ">
                            <div class="form-group ">
                                <div class="form-check form-check-inline">
                                    ...
                                    <input type="date" class="form-control form-control-sm text-primary" id="DataAnuencia" name="DataAnuencia" value="<?= isset($provimento['data_amuencia']) ? $provimento['data_anuencia'] : '' ?>" disabled>
                                ...
                                <div class="form-check form-check-inline">
                                    ...
                                    <input type="date" class="form-control form-control-sm text-primary" id="DataAssuncao" name="DataAssuncao" value="<?= isset($provimento['data_assuncao']) ? $provimento['data_assuncao'] : '' ?>" disabled>
                                </div>
                            </div>
                        </div>
                        ...
                        <hr>
                        <div class="form-group col-md-12">
                            <h3 class="control-label text-primary" for="CodNte">Carga Horária Por Componente e Turno </h3>
                            <!-- <div class="form-group col-md-12"> -->
                                        ...
                                        <?php if (isset($provimento_provido)) : ?>
                                            ...
                                            <?php foreach ($provimento_provido as $provido) : ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center bg-secondary  text-white"><?php echo $provido['mat_old'] ?></td>
                                                    <td class="text-center bg-primary text-white"><?php echo $provido['mat'] ?></td>
                                                    <td class="text-center bg-secondary  text-white"><?php echo $provido['vesp_old'] ?></td>
                                                    <td class="text-center bg-primary text-white"><?php echo $provido['vesp'] ?></td>
                                                    <td class="text-center bg-secondary  text-white"><?php echo $provido['not_old'] ?></td>
                                                    <td class="text-center bg-primary text-white"><?php echo $provido['not'] ?></td>
                                                    <td class="text-center bg-primary text-warning"><?php echo $provido['total'] ?></td>
                                                </tr>
